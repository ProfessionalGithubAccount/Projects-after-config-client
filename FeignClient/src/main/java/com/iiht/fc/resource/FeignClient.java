...
public class FeignClient {
	 ...
	 @CircuitBreaker(name="client-circuit-breaker",fallbackMethod="generateResponse")
	 ...
	 public String generateResponse(Throwable throwable) {
		 return "The server is unavailable now..please try again again again ...";
		 //the method name should be same as fallbackMethod value only
	 }
}
